...
> **Authoring status:** All 197 tests now carry replayable inputs and exact expected observations. The former `params.scenario` dispatch and prose-only `contract` assertions have been removed; independent conformance peer review remains required.
