...
- [x] **8b — Structural validation and lint.** `python3 scripts/validate-suite.py` passes 197 tests, 19 categories, and 197 unique IDs. `deno run --allow-read ~/personal/cdd-skills/tools/golden-lint.ts conformance` reports 0 errors and 0 warnings.
